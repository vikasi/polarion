(function(stylesheet, stencils, js)
{
	...
	var mxCellRendererGetLabelValue = mxCellRenderer.prototype.getLabelValue;
	mxCellRenderer.prototype.getLabelValue = function(state)
	{
		var result = mxCellRendererGetLabelValue.apply(this, arguments);
					...
					(function(container)
					{
						try
						{
							...
							if (xmlDocument.documentElement != null && xmlDocument.documentElement.nodeName == 'mxGraphModel')
							{
								...
								if ((fit != '1' && resize != '0') || (container.style.width == '' && container.style.height == ''))
								{
									    ...
									    {	
									    	...
									    	if (data != null)
									    	{
									    		...
									    		if (newDocument.documentElement.nodeName == 'mxfile')
									    		{
									    			...
									    			{
									    				data = decodeURIComponent(RawDeflate.inflate(Base64.decode(mxUtils.getTextContent(diagrams[0]), true)));
