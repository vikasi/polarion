...
//IMA		<table class="mceEditor" border="0" cellpadding="0" cellspacing="0" width="{$width}" height="{$height}"><tbody>\
	var str = '\
		<table class="mceEditor" border="0" cellpadding="0" cellspacing="0" width="99%" height="{$height}"><tbody>\
    ...
    str += this.TOOLBAR_SPACER + this.getTableToolbar() + this.TOOLBAR_SPACER + this.getTableRowToolbar() +
           this.TOOLBAR_SPACER + this.getTableColToolbar() + 
           /* this.TOOLBAR_SPACER + */
           this.getLinkToolbar();
