...
function compareRevisions(diff_url, type, labelSelectRev) {
        diff_url = document.forms['revisionform'].action;
	var revisions = document.forms['revisionform'].elements['revision'];
	var countRevisions = revisions.length;
	var checkedRevisions = 0;
	var firstRevision;
	...
	if (checkedRevisions < 2)
	{
		alert(labelSelectRev);
	}
	else if (checkedRevisions == 2)
	{
	        var leftName = document.getElementById("namePageRev"+leftRevision).value;
	        var rightName = document.getElementById("namePageRev"+rightRevision).value;
	        var leftSpace = document.getElementById("spacePageRev"+leftRevision).value;
	        var rightSpace = document.getElementById("spacePageRev"+rightRevision).value;

		document.location.href=diff_url+'&rev1='+leftRevision+'&rev2='+rightRevision+'&type='+type+"&leftName="+leftName+"&rightName="+rightName+"&leftSpace="+leftSpace+"&rightSpace="+rightSpace;
	}
}
