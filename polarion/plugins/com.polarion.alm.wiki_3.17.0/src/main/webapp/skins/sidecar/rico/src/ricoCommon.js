...
Rico.Shadow.prototype = {
  ...
  initialize: function(DivRef) {
    ...
    if (typeof this.div.style.filter=='undefined') {
      new Image().src = Rico.imgDir+"blank.gif";
      new Image().src = Rico.imgDir+"blank.gif";
      new Image().src = Rico.imgDir+"blank.gif";
      this.createShadow();
      this.offset=5;
  ...
  createShadow: function() {
    ...
    td12.style.background="transparent url("+Rico.imgDir+"blank.gif"+") no-repeat right bottom"

    var tr2=tab.insertRow(-1);
    var td21=tr2.insertCell(-1);
    td21.style.background="transparent url("+Rico.imgDir+"blank.gif"+") no-repeat right bottom"
    var td22=tr2.insertCell(-1);
    td22.style.background="transparent url("+Rico.imgDir+"blank.gif"+") no-repeat right bottom"
