 ...
 */
  ...
  sizeDivs: function() {
    ...
    if($('SpaceIndex_tab'))
    {
       w = parseInt($('panelView').style.width) - margin;
       w1 = w - this.options.scrollBarWidth + "px";
       $('SpaceIndex_tabitemTable_scrollDiv').style.width = w + "px";
       $('SpaceIndex_tabitemTable_outerDiv').style.width = w + "px"
       $('SpaceIndex_tabitemTable_innerDiv').style.width = w1;  
       $('mainlayoutsubsection').style.height = $('SpaceIndex_tabitemTable_outerDiv').style.height;
//       $('SpaceIndex_tab').style.height = parseInt($('SpaceIndex_tabitemTable_outerDiv').style.height) + 2 + "px";  
//       $('SpaceIndex_tab').style.border = '1px solid #74A7E1;';
  ...
  remainingHt: function() {
    ...
    var margin=Prototype.Browser.IE ? 40 : 35;
    switch (this.sizeTo) {
      case 'window':
      case 'data':
