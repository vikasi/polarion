...
if (isRTL) {
%>
	<frame name="ContentViewFrame" title="<%=ServletResources.getString("aView", ServletResources.getString("topic", request), request)%>" src='<%=frameURL%>' marginwidth="5" marginheight="5">
