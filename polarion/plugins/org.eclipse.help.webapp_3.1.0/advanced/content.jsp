...
<frameset id="contentFrameset" onload="onloadHandler()" rows="24,*" frameborder="0" framespacing="0" border=0 spacing=0>
	...
	<frame ACCESSKEY="K" name="ContentViewFrame" onload="onloadHandler2()" title="<%=ServletResources.getString("topicView", request)%>" src='<%=frameURL%>'  marginwidth="10"<%=(data.isIE() && "6.0".compareTo(data.getIEVersion()) <=0)?"scrolling=\"yes\"":""%> marginheight="0" frameborder="0" >
</frameset>
