...
dhtmlxGantt v.3.1.0 Professional
This software is covered by DHTMLX Enterprise License. Usage without proper license is prohibited.

(c) Dinamenta, UAB.
*/
Gantt.plugin(function(t){t._markers||(t._markers={}),t.config.show_markers=!0,t.attachEvent("onClear",function(){t._markers={}}),t.attachEvent("onGanttReady",function(){function e(e){if(!t.config.show_markers)return!1;if(!e.start_date)return!1;var n=document.createElement("div");n.setAttribute("marker_id",e.id);var i="gantt_marker";t.templates.marker_class&&(i+=" "+t.templates.marker_class(e)),e.css&&(i+=" "+e.css),e.title&&(n.title=e.title),n.className=i;var a=t.posFromDate(e.start_date);if(n.style.left=a+"px",n.style.height=Math.max(t._y_from_ind(t._order.length),0)+"px",e.end_date){var s=t.posFromDate(e.end_date);
n.style.width=Math.max(s-a,0)+"px"}return e.text&&(n.innerHTML="<div class='gantt_marker_content' >"+e.text+"</div>"),n}var n=document.createElement("div");n.className="gantt_marker_area",t.$task_data.appendChild(n),t.$marker_area=n,t._markerRenderer=t._task_renderer("markers",e,t.$marker_area,null)}),t.attachEvent("onDataRender",function(){t.renderMarkers()}),t.getMarker=function(t){return this._markers?this._markers[t]:null},t.addMarker=function(t){return t.id=t.id||dhtmlx.uid(),this._markers[t.id]=t,t.id
