...
window.CodeMirror = (function() {
  ...
  function completeAfter(cm, tags, pred) {
	    var cur = cm.getCursor();
	    if (!pred || pred())
	        setTimeout(function() {
  ...
  CodeMirror.completeAfter = completeAfter;

	function completeIfAfterLt(cm, tags) {
	    return completeAfter(cm, tags, function() {
	        var cur = cm.getCursor();
	        return cm.getRange(CodeMirror.Pos(cur.line, cur.ch - 1), cur) == "<";
	    });
	}
	
	CodeMirror.completeIfAfterLt = completeIfAfterLt;

	function completeIfInTag(cm, tags) {
	...
	CodeMirror.completeIfInTag = completeIfInTag;
