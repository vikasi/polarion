...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" >
	<head>
		...
		<script src="/polarion/ria/javascript/solid-gauge.js?buildId=<%=com.polarion.portal.jetspeed.gwt.GWTServletProxy.getBuildId()%>" type="text/javascript"></script>
  		...
  		<link href="/polarion/gwt/gwt/polarion/dle_print.css?buildId=<%=com.polarion.portal.jetspeed.gwt.GWTServletProxy.getBuildId()%>" rel="stylesheet" type="text/css"/>
  		<link href="/polarion/ria/font-awesome-4.0.3/css/font-awesome.css" rel="stylesheet">  		
  	</head>
	<body class="polarion-dle-document polarion-dle-document-print withResolvedComments">
	</body>
</html>
