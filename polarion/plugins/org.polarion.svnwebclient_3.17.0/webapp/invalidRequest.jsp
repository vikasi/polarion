...
<jsp:useBean id="bean" scope="request" class="org.polarion.svnwebclient.web.controller.InvalidRequestBean"/>
<%
    if (bean.execute(request, response)) {
%>
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="<%= Localization.getString("svnwebclient.invalidRequest.title") %>"/>
    </jsp:include>
    <body>
                    ...
                    <table align="center" class="dialog" cellspacing="0" cellpadding="0" width="50%">
                                ...
                                <table width="100%" class="valueListTitle" cellpadding="0" cellspacing="0" >
                    			    <tr>
                                        <td style="padding-left:10px;padding-right:10px;">
                                            <%= Localization.getString("svnwebclient.invalidRequest.resource") %>
                                        </td>            
                                    </tr>
                                </table>    
                            </td>
                        ...
                        <tr>
                           <td style="padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:20px;">
                               <jsp:include page="include/dialog/invalidRequestContent.jsp"/>
                           </td>
                        </tr>   
                         <tr>
                            <td width="100%" style="padding-left:10px;padding-right:10px;padding-top:0px;padding-bottom:20px;">
                                <jsp:include page="include/dialog/invalidRequestButtons.jsp"/>
                            </td>    
                        </tr>
