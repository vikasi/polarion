...
%>            
        ...
        <td class="value" style="padding-left:20px;" nowrap="true">
            ...
            <span title="<%= Localization.getString("svnwebclient.revprops.ago", bean.getFileContent().getAge()) %>"><%=bean.getFileContent().getDate()%></span>
        </td>        
        <td class="value" style="padding-left:20px;" nowrap="true">
            <b><%= Localization.getString("svnwebclient.revpropscol.author") %></b>&nbsp;
            <%=bean.getFileContent().getAuthor()%>
        </td>
        <td class="value" style="padding-left:20px;" nowrap="true">
            <b><%= Localization.getString("svnwebclient.fileContentInfo.size") %></b>&nbsp;
