...
%>             
                <%= Localization.getString("svnwebclient.navigation.pathWithRevision", navigation.getCurrentRevision()) %>
<%
        } else {
%>    
                <%= Localization.getString("svnwebclient.navigation.pathWithoutRevision") %>
<%
        }
%>    
            </span>
...
%>			
					<td nowrap="true">
                    	 <a class="path_t" href="<%=pathElement.getUrl()%>"><span  class="path_text"><%=pathElement.getName()%></span></a>        
                    </td>
<%
			} else {						
%>				
...
%>        
            <a href="<%=button.getUrl()%>">
                <img src="<%=button.getImage()%>" alt="<%=button.getCaption()%>" title="<%=button.getCaption()%>" style="white-space:pre; padding:0 10 0 0; margin:0 0 0 0; cursor:pointer;" border="0"/>
            </a>
        </td>        
<%
        }
