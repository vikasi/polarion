...
<form name="directoryAdd" method="POST" action="<%=bean.getOkUrl()%>" style="padding:0;margin:0;">
    <table class="dialogcontent" cellspacing="0" cellpadding="0" width="100%" height="100%">
        <tr>
            <td>
                <b><%= Localization.getString("svnwebclient.changeConfirmationContent.message") %></b>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td style="padding-top:10px;">
                <b><%= Localization.getString("svnwebclient.changeConfirmationContent.changedElements") %></b>
            </td>
        </tr>
        <tr>
            <td>
