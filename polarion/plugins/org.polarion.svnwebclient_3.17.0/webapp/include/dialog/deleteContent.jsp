...
<form name="directoryAdd" method="POST" action="<%=bean.getOkUrl()%>" style="padding:0;margin:0;">
    <table class="dialogcontent" cellspacing="0" cellpadding="0" width="100%" height="100%">
        <tr>
            <td>
                <b><%= Localization.getString("svnwebclient.deleteContent.areYouSure") %></b>
            </td>
        </tr>
        <tr>
            <td>
...
%>        
        ...
        <tr>
            <td>
                <textarea id="comment" name="comment" rows="5" style="width:100%;margin:0;font-size:11px;"><%= Localization.getString("svnwebclient.deleteContent.defaultComment") %></textarea>
            </td>
        </tr>           
        <tr>
