...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="<%= Localization.getString("svnwebclient.error.title") %>"/>
    </jsp:include>
    <body>
            ...
            <tr height="100%">
                <td style="padding:0;spacing:0px; padding-left:5px; padding-right:5px; padding-top:5px;padding-bottom:5px;" height="100%">
                    <jsp:include page="include/dialog.jsp">
                        <jsp:param name="jsp.dialog.title" value="<%= Localization.getString("svnwebclient.error.dialogTitle") %>"/>
