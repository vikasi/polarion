...
<jsp:useBean id="bean" scope="request" class="org.polarion.svnwebclient.web.controller.file.FileUpdateBean"/>
<%
    if (bean.execute(request, response)) {
%>
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="<%= Localization.getString("svnwebclient.fileUpdate.title") %>"/>
    </jsp:include>
    <body>
...
%>              
                <td style="padding:0;spacing:0px; padding-left:5px; padding-right:5px; padding-top:2px;padding-bottom:5px;">
                    <jsp:include page="include/dialog.jsp">
                        <jsp:param name="jsp.dialog.title" value="<%= Localization.getString("svnwebclient.fileUpdate.dialogTitle") %>"/>
                        <jsp:param name="jsp.dialog.fullwidth" value="true"/>
                        <jsp:param name="jsp.dialog.content" value="fileUpdateContent.jsp"/>
