...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="<%= Localization.getString("svnwebclient.invalidResource.title") %>"/>
    </jsp:include>
    <body>
                                ...
                                <table width="100%" class="valueListTitle" cellpadding="0" cellspacing="0" >
                    			    <tr>
                                        <td style="padding-left:10px;padding-right:10px;">
                                            <%= Localization.getString("svnwebclient.invalidResource.resource") %>
                                        </td>            
                                    </tr>
                                </table>    
                            </td>
