...
import org.polarion.svnwebclient.web.model.data.file.*;
...
public final class fileContent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("org.polarion.svnwebclient.web.model.data.file");
...
return;
    ...
    try {
      ...
      if (bean == null){
        bean = new org.polarion.svnwebclient.web.controller.file.FileContentBean();
    ...
    if (bean.execute(request, response)) {
      ...
      out.write("<html>\r\n");
      out.write("    ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "include/head.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("jsp.head.title", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf( Localization.getString("svnwebclient.fileContent.title") ), request.getCharacterEncoding()), out, false);
      out.write("\r\n");
      out.write("    <body>\r\n");
      out.write("        <table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" height=\"99%\">\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td>\r\n");
      out.write("                    ");
      ...
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td style=\"padding:0px;spacing:0px; padding-left:5px; padding-right:5px; padding-top:2px;\">\r\n");
      out.write("                    ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "include/infoPanel.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("jsp.infoPanel.info", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("fileContentInfo.jsp", request.getCharacterEncoding()) + "&" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("jsp.infoPanel.options", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("fileContentOptions.jsp", request.getCharacterEncoding()), out, false);
      out.write("\r\n");
      out.write("                </td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td width=\"100%\" height=\"100%\" style=\"padding:0px;spacing:0px; padding-left:5px; padding-right:7px;\">\r\n");
      out.write("                    <iframe class=\"frame\" id=\"content_frame\" name=\"content_frame\" width=\"100%\" height=\"100%\" frameborder=\"0\" src=\"");
      out.print(bean.getSelectedViewUrl());
      out.write("\">\r\n");
      out.write("                        <a href=\"");
      out.print(bean.getSelectedViewUrl());
      out.write('"');
      out.write('>');
      out.print( Localization.getString("svnwebclient.fileContent.content") );
      out.write("</a>\r\n");
      out.write("                    </iframe>\r\n");
      out.write("                </td>\r\n");
      out.write("            </tr>\r\n");
