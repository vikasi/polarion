...
public final class revisionDetailsInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("</b>&nbsp;\r\n");
      out.write("            ");
      out.print(bean.getRevision().getDecoratedRevision());
      out.write('\r');
      out.write('\n');
    ...
    if (bean.getRevision().isHeadRevision()) {
      ...
      out.print( Localization.getString("svnwebclient.revprops.ago", bean.getRevision().getAge()) );
      out.write('"');
      out.write('>');
      out.print(bean.getRevision().getDate());
      out.write("</span>\r\n");
      out.write("        </td>        \r\n");
      out.write("        <td class=\"value\" style=\"padding-left:20px;\" nowrap=\"true\">\r\n");
      out.write("            <b>");
      ...
      out.write("</b>&nbsp;\r\n");
      out.write("            ");
      out.print(bean.getRevision().getAuthor());
      out.write("\r\n");
      out.write("        </td>\r\n");
      out.write("        <td class=\"value\" style=\"padding-left:20px;\" nowrap=\"true\">\r\n");
      out.write("            <b>");
      ...
      out.write("</b>&nbsp;\r\n");
      out.write("            ");
      out.print(bean.getRevision().getChangedElementsCount());
      out.write("\r\n");
      out.write("        </td>\r\n");
	...
	if (bean.getRevision().isMultiLineComment()) {
      ...
      out.write("\t\t\t\t");
      out.print(bean.getRevision().getTooltip());
      out.write("\t\r\n");
      out.write("\t\t\t</div>\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t<b>");
      ...
      out.write("\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;");
      out.print(bean.getRevision().getFirstLine());
      out.write("\t\t\t\t\r\n");
      out.write("\t\t</td>\t\r\n");
      ...
      out.write("</b>&nbsp;\r\n");
      out.write("            ");
      out.print(bean.getRevision().getComment());
      out.write("\r\n");
      out.write("        </td>\r\n");
